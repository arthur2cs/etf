...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _minOrderController = TextEditingController(
      text: repo.minOrderAmount.toStringAsFixed(0),
    );
    _commissionRateController = TextEditingController(
      text: repo.commissionRatePct.toStringAsFixed(2),
    );
  }
    ...
    return ListView(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            labelText: 'Montant minimum par ordre BoursoBank (€)',
          ),
          keyboardType: const TextInputType.numberWithOptions(decimal: true),
          onChanged: (v) {
            final value = double.tryParse(v.replaceAll(',', '.'));
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            ...
            helperText:
                'Utilisé pour calculer le montant exact à virer (achat + commission).',
            helperMaxLines: 2,
          ),
          keyboardType: const TextInputType.numberWithOptions(decimal: true),
          onChanged: (v) {
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Catégorie (ex. Europe, US, Émergents)',
              ),
            ),
            TextField(
